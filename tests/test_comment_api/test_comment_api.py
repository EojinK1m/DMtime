...
def test_comment_patch_correct(
    client,
    create_temp_account,
    create_temp_gallery,
    create_temp_post,
...
def test_comment_patch_without_content_key(
    client,
    create_temp_account,
    create_temp_gallery,
    create_temp_post,
...
def test_comment_patch_without_access_token(
    ...
    rv = client.patch(url + f"{temp_comment.id}", json=change_comment_info)

    assert rv.status_code == 401


def test_comment_patch_with_another_account(
    client,
    create_temp_account,
    create_temp_gallery,
    create_temp_post,
...
def test_comment_patch_with_oversize_content(
    client,
    create_temp_account,
    create_temp_gallery,
    create_temp_post,
...
def test_comment_delete_correct(
    client,
    create_temp_account,
    create_temp_gallery,
    create_temp_post,
...
def test_comment_delete_with_admin_account(
    client,
    create_temp_account,
    create_temp_gallery,
    create_temp_post,
...
def test_comment_delete_with_another_account(
    client,
    create_temp_account,
    create_temp_gallery,
    create_temp_post,
...
def test_comment_delete_not_exist_comment(client, create_temp_account):
    temp_account = create_temp_account()
...
def test_comment_delete_without_access_token(
    client,
    create_temp_account,
    create_temp_gallery,
    create_temp_post,
