...
def test_check_already_using_email_duplication_response_200_and_usable_false(
    client, test_user
):
...
def test_email_duplication_check_without_email_parameter_response_400(client):
...
def test_check_using_username_duplication_response_200_and_usable_false(
    client, test_user
):
...
def test_email_duplication_check_without_username_parameter(client):
