...
account_api.add_resource(DuplicateCheckEmail, '/account/duplicate-check/email/<email>')
account_api.add_resource(DuplicateCheckUsername, '/account/duplicate-check/username/<username>')